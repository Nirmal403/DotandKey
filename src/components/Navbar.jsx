...
function DrawerExample() {
  ...
  return (
    <>
      <Button ref={btnRef} colorScheme="white">
        <Box marginLeft={"0px"} w={"25px"}>
          {" "}
          {BagIcon}
        </Box>
      </Button>
      ...
      >
        ...
        <DrawerContent>
          ...
          <DrawerBody>
            <h4>
              Congratulations! 1 D&K Full Size Freebie added to your cart for{" "}
              <span style={{ color: "pink" }}>FREE</span>
            </h4>
            <br />
            <h3>
              Add 6 worth of products to get Full Size Freebie worth
              <span style={{ color: "pink" }}> Rs.1089</span> for{" "}
              <span style={{ color: "pink" }}>FREE</span>
            </h3>
          </DrawerBody>
...
const locationSvg = (
  <a href="https://www.dotandkey.com/apps/shipway_track">
    {" "}
    <img
      style="height: 27px;"
...
const Navbar = () => {
  return (
    <div className={styles.nav}>
     <Link to="/" className={styles.logo}><Image
      ...
      <div className={styles.icons}>
        ...
        <Box w={"25px"}>
          {" "}
          <a href="/">
            <Img src="https://cdn.shopify.com/s/files/1/0361/8553/8692/files/Group_346.svg?v=1655211633"></Img>
          </a>
        </Box>
        <Box marginLeft={"10px"} w={"25px"}>
          {" "}
          <DrawerExample />
        </Box>

        <Link style={{textDecoration:"none",color:"black"}}to="login">
          <span style={{marginLeft:"20px", fontSize:"28px" }}class="material-symbols-outlined">person</span>
        </Link>
      </div>
    </div>
  );
